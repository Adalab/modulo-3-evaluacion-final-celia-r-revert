  ...
  return (
    <>
      ...
      <form className='spotlight__form' action="submit" method='POST' > 
        <label className='spotlight__movie' htmlFor="movie">Película</label>
        <input  className='spotlight__input' type="text" name='movie' id='movie' required/>
        <label className='spotlight__year' htmlFor="year">Año</label>
